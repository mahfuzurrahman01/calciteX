            ...
            <header className="p-4  bg-white shadow-lg shadow-gray-200   duration-300 relative ">
                <div className="lg:w-11/12 w-full flex justify-between h-16 mx-auto">
                    ...
                    <ul className="items-stretch  space-x-3  lg:flex hidden">
                        <li className="flex">
                            <NavLink to='/' rel="noopener noreferrer" href="# " className={({ isActive }) => isActive ? "flex items-center px-4 text-blue-600 text-xl font-semibold -mb-1 border-b-2  border-transparent" : "flex items-center px-4 text-gray-900 hover:text-blue-600 text-xl font-semibold -mb-1 border-b-2  border-transparent"}>Home</NavLink>
                        </li>
                        <li className="flex">
                            <NavLink to='/about' rel="noopener noreferrer" href="# " className={({ isActive }) => isActive ? "flex items-center px-4 text-blue-600 text-xl font-semibold -mb-1 border-b-2  border-transparent" : "flex items-center px-4 text-gray-900 hover:text-blue-600 text-xl font-semibold -mb-1 border-b-2  border-transparent"}>About us</NavLink>
                        </li>
                        <li className="flex">
